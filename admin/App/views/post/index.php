                                            ...
                                            <tbody>
                                                <?php foreach ($posts as $each) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="edit-btn" data-id="<?php echo $each['id'] ?>" data-name="<?php echo $each['fullname'] ?>" data-email="<?php echo $each['email'] ?>" data-password="<?php echo $each['password'] ?>" data-role="<?php echo $each['role'] ?>">
